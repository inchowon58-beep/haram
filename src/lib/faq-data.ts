...
export const HOME_FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    a: `네, 하람보호소는 특정 지역 매장 없이 전국파양입소 및 무료분양 서비스를 운영합니다. 거주 지역과 관계없이 전화(${SITE.phone})로 상담하시면 가까운 방문 픽업 또는 이동 방법을 함께 안내해 드립니다.`,
  },
  {
    q: "무료분양은 정말 비용이 없나요?",
  ...
  {
    q: "개인 직거래나 소규모 시설과 무엇이 다른가요?",
    a: "하람보호소는 입소 후 케어·성향 맞춤 매칭·재파양 시 재보호까지 책임집니다. 행방 불명·과밀 합사·악용 위험이 큰 직거래·검증되지 않은 시설과 달리, 상담부터 사후 관리까지 투명하게 안내합니다.",
  },
  {
  ...
  },
  {
    ...
    a: "입소 후에는 산책·목욕·식사·기본 건강 상태 확인 등 아이 중심의 일상 케어를 진행합니다. 새 가족과 매칭될 때까지 안전하게 보호하며, 필요한 경우 근황 사진도 안내해 드립니다.",
  },
];
...
/** 특정 주소 없는 전국 서비스 — Organization + ContactPoint */
