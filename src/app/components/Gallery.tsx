...
export default function Gallery() {
  return (
    <section id="gallery" className="haram-section">
      <div className="haram-container">
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
          <div className="haram-sec-header align-left">
            <span className="haram-badge">Protected Pets</span>
            <h2 className="haram-sec-title">
              새 가족을 <em>기다리는 아이들</em>
            </h2>
            <p className="haram-sec-desc max-w-xl">
              파양으로 입소한 아이들이 새 가족을 기다리고 있습니다. {SITE.brand}에서
              먼저 확인하고 전화 상담으로 무료분양 매칭을 진행해 주세요.
            </p>
          </div>
          <a href={SITE.phoneTel} className="haram-btn-main shrink-0">
            매칭 상담하기
          </a>
        </div>

        <div className="haram-gallery-grid">
          {ADOPTION_GALLERY.map((pet) => (
            <article key={pet.name} className="haram-gallery-card">
              <div className="haram-gallery-thumb">
                <Image
                  src={pet.src}
              ...
              <div className="haram-gallery-info">
